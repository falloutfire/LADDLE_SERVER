...
INSERT INTO users (id, first_name, last_name, middle_name, username, password, shop_id)
VALUES (2, 'Admin', 'Admin', '_', 'admin', '$2a$04$EZzbSqieYfe/nFWfBWt2KeCdyq0UuDEM1ycFF8HzmlVR6sbsOnw7u', 1);
INSERT INTO users (id, first_name, last_name, middle_name, username, password, shop_id)
VALUES (1, 'Ilya', 'Man', '_', 'user', '$2a$10$4s9YkGQYo6F.RCMHympTTe8ouesx0TkG/E4aJEec3V7pNkI0rvEXi', 2);
